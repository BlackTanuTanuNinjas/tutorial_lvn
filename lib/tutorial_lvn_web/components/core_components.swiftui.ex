defmodule TutorialLvnWeb.CoreComponents.SwiftUI do
  @moduledoc """
  ...
  of the `TutorialLvnWeb.CoreComponents` functions you should expect identical functionality for similarly named
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(TutorialLvnWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(TutorialLvnWeb.Gettext, "errors", msg, opts)
    end
  end
