defmodule TutorialLvnNative do
  @moduledoc """
  ...
  import TutorialLvnWeb, only: [verified_routes: 0]
  ...
  def live_view() do
    quote do
      use LiveViewNative.LiveView,
        ...
        layouts: [
          swiftui: {TutorialLvnWeb.Layouts.SwiftUI, :app}
        ],
  ...
  defp helpers(format) do
    ...
    core_component_module = Module.concat([TutorialLvnWeb, CoreComponents, plugin.module_suffix])
